...
export const Profile: React.FC<ProfileProps> = ({ user, setView }) => {
  ...
  return (
    <>
      ...
      <div id="email-wrap" className="w-1/2 rounded-md ring-2 ring-gray-100 p-3 my-10">
      ...
      <div id="delete-wrap" className="w-1/2 rounded-md ring-2 ring-gray-100 p-3 my-10">
